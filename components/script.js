...
// for (let i in deck) {
//     let card = deck[i]
//     if (substring(card, 1, length(card))) {

//     } else {
//         let suit = chartAt(card, 0);
//     }
// }
// }
...
class zhuSuitNumberLabel extends React.Componenet {
    render() {
        return (
            <>
...
class zhuNumberLabel extends React.Componenet {
    render() {
        return (
            <>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 47.98 46.37" fill="#00ad11">
...
class zhuSuitLabel extends React.Component {
    render() {
        return (
            <>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 47.98 46.37" fill="#00ad11">
